...
import api from '../../../api'
import { fetchBotHealth, fetchBots, fetchBotTemplates } from '../../../reducers/bots'
...
class Bots extends Component<Props> {
  state = {
    ...
    isCloneTemplateModalOpen: false,
  ...
  toggleCloneBotModal = (botId?: string) => {
    this.setState({
      isCloneTemplateModalOpen: !this.state.isCloneTemplateModalOpen,
        ...
        {bots.map(bot => (
          <Fragment key={bot.id}>
            <BotItemCompact
              ...
              cloneBot={this.toggleCloneBotModal.bind(this, bot.id)}
        ...
        <SplitPage sideMenu={!this.isPipelineView && this.renderCreateNewBotButton()}>
          <Fragment>
            ...
            <AccessControl resource="admin.bots.*" operation="write">
              ...
              <CloneBotModal
                botId={this.state.focusedBot}
                isOpen={this.state.isCloneTemplateModalOpen}
                toggle={this.toggleCloneBotModal}
                onCloneTemplateSuccess={this.props.fetchBotTemplates}
              />
              <ImportBotModal
